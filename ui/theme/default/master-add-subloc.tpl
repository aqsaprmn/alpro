		...
		<div class="row">
			<div class="col-sm-12 col-md-12">
				<div class="panel panel-default panel-hovered panel-stacked mb30">
					<div class="panel-heading">{$_L['Add']} {$_L['SubLoc']}</div>
						<div class="panel-body">
						<form id="formInputTable" class="form-horizontal" method="post" role="form" action="{if isset($idloc)}{$_url}master/add_sublocation_post/{$idloc}/{else}{$_url}master/add_sublocation_post/{/if}">      
							<div class="form-group">
								<label class="col-md-2 control-label">ID {$_L['Location']}</label>
								<div class="col-md-6">
									<input type="text" class="form-control" name="idlokasi" id="idlokasi" required autocomplete="off" value="{if isset($idloc)}{$idloc}{/if}">
								</div>
